...
Quite frankly, [Jesper](https://github.com/jesperpedersen){:target="_blank"} did and is doing a great job in making contributions pushes and pulls from the so called *sister projects* like [pgmoneta](https://pgmoneta.github.io/){:target="_blank"} and [pgexported](https://pgexporter.github.io/){:target="_blank"} and this also helps in getting attention to the project, as well as increases the capability of code reviews and quality.
...
Please stat by visiting the [new pgagroal web site](https://pgagroal.github.io/){:target="_blank"} and reading the [documentation](https://pgagroal.github.io/documentation.html){:target="_blank"} and fire up your own pooler instance!
